...
\label{sec:intro}
Thanks in part  to evolutionary computation (EC) research, scientists
and engineers from many fields now understand the remarkable power of
the natural search process described by the biological theory of
Neo-Darwinian evolution \cite{}. 
...
methods in a variety of areas and problem domains \cite{}. %Empty
                                %statement, maybe delete. 
...
%% Podriamos enfocar mas el tema a Pool-based DPA? Creo que DPA es todavia mas general -Mario
% Lo digo por que en otros trabajos hemos partido de ahi y mencionanamos otros
% trabajos como A-teams, Sofea, etc.. Ahora no se si los findings de este trabajo nos den para generalizar a otros DPA. -Mario
