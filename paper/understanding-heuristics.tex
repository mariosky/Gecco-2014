...
which are mostly coded as sequential and synchronous algorithms
\cite{eiben}.
...
peer-to-peer (P2P), and web environments. % references - JJ

These technologies are intended for the development of parallel, distributed and asynchronous systems,
so that an EA developed on top of them could easily reap the benefits of these features.
...
Using randomized parameter settings falls withing the area of
...
obtain decent results, at least comparable to the best homogeneized
